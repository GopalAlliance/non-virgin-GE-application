...
const Application = ({ formData, setFormData }) => {
  ...
  const isValid = () => {
    ...
    if (
      formData.contact_f_name === "" ||
      formData.contact_f_name === undefined
    ) {
      valid = false;
    }
    if (
      formData.contact_l_name === "" ||
      formData.contact_l_name === undefined
    ) {
      valid = false;
    }
    ...
    if (
      ...
      formData.companyProvince === undefined
    ) {
      valid = false;
    }
  ...
  const sendFormData = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_GROUP_ENROLL_ENDPOINT}`,
        data
      );
      console.log(process.env.REACT_APP_GROUP_ENROLL_ENDPOINT);
  ...
  return (
    <div className="group-enroll-application-form-container">
      {formData.language === "fr" ? (
        <div className="group-enroll-application-form-header">
      ...
      <div className="group-enroll-application-form">
        <div className="group-enroll-input-field">
          {formData.language === "fr" ? (
            <label htmlFor="first-name-field">
              Prénom du administrateur du régime
            </label>
          ) : (
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, contact_f_name: e.target.value })
            }
          ></input>
        </div>
        <div className="group-enroll-input-field">
          {formData.language === "fr" ? (
            <label htmlFor="last-name-field">
              Nom de famille du administrateur du régime
            </label>
          ) : (
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, contact_l_name: e.target.value })
            }
          ></input>
        </div>
        <div className="group-enroll-input-field">
          {formData.language === "fr" ? (
            <label htmlFor="plan-admin-title-field">
              Poste de administrateur du régime
            </label>
          ) : (
        ...
        <div className="group-enroll-input-field">
          ...
          <InputMask
            ...
            maskChar=""
            onChange={(e) =>
              setFormData({ ...formData, companyTel: e.target.value })
            }
          >
        ...
        <div className="group-enroll-input-field">
          ...
          <InputMask
            ...
            maskChar=""
            onChange={(e) =>
              setFormData({ ...formData, companyPostal: e.target.value })
            }
          >
        ...
        <div className="group-enroll-input-field">
          ...
          {formData.language === "fr" ? (
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, companyProvince: e.target.value })
              }
            >
      ...
      {formData.companyProvince === "QC" ? (
        <div className="preferred-language-container">
          ...
          <div className="preferred-language-button-group">
            ...
            <div
              className={
                formData.preferred_language === "fr"
                  ? "selected-language"
                  : null
              }
              onClick={() =>
                setFormData({ ...formData, preferred_language: "fr" })
              }
            >
              {formData.language === "fr" ? (
                <span>Français</span>
      ...
      {formData.language === "fr" ? (
        <div className="group-enroll-application-form-header">
          Chargez vos documents (facultatif) - max. 10 MB
        </div>
      ) : (
        <div className="group-enroll-application-form-header">
          Upload Your Documents (Optional) - max. 10 MB
        </div>
      )}
      ...
      <div
        ...
        className={
          dropState === "drop-active"
            ? "group-enroll-upload-document-section drop-active"
            : "group-enroll-upload-document-section"
        }
        ...
        {file
          ? Array.from(file).map((action, index) => (
              <div className="group-enroll-document-box" key={index}>
                <div className="document-name">{action.name}</div>
      ...
      {formData.language === "fr" ? (
        <div className="group-enroll-application-form-header">
          Informations sur les débits préautorisés
        </div>
      ) : (
        <div className="group-enroll-application-form-header">
      ...
      <div className="group-enroll-banking-information-section">
        <div className="group-enroll-payor-section">
          <div className="group-enroll-input-field">
            {formData.language === "fr" ? (
              <label htmlFor="payor-name-field">
                Nom du payeur / Nom de l'entreprise
              </label>
            ) : (
              <label htmlFor="payor-name-field">
                Name of Payor / Name of Company
              </label>
            )}
            <input
              id="payor-name-field"
              ...
              onChange={(e) =>
                setFormData({ ...formData, payorName: e.target.value })
              }
            ></input>
          </div>
          {formData.companyName.length > 0 &&
          formData.companyName !== formData.payorName ? (
            <div>
              {formData.language === "fr" ? (
                <div
                  style={{ marginTop: 5 }}
                  className="group-enroll-button"
                  onClick={() => setSameAsCompany()}
                >
        ...
        <div className="group-enroll-bank-details-section">
          <div className="group-enroll-input-field">
            {formData.language === "fr" ? (
              <label htmlFor="institution-number-field">
                Numéro de institution
              </label>
            ) : (
              <label htmlFor="institution-number-field">
                Institution Number
            ...
            <InputMask
              ...
              maskChar=""
              onChange={(e) =>
                setFormData({ ...formData, institutionNum: e.target.value })
              }
            >
          ...
          <div className="group-enroll-input-field">
            ...
            <InputMask
              ...
              maskChar=""
              onChange={(e) =>
                setFormData({ ...formData, transitNum: e.target.value })
              }
            >
          ...
          <div className="group-enroll-input-field">
            {formData.language === "fr" ? (
              <label htmlFor="account-number-field">
      ...
      <div className="group-enroll-banking-opt-in-section">
        <div>
          ...
          <SpecificationsAndAssumptions
            formData={formData}
            setFormData={setFormData}
          />
          <div className="form-checkbox-group">
            <input
              id="plan-specifications-and-assumptions-checkbox"
              type="checkbox"
              value={assumptionsCheck}
              onChange={() => setAssumptionsCheck(!assumptionsCheck)}
            />
            <label htmlFor="plan-specifications-and-assumptions-checkbox">
              {formData.language === "fr" ? (
                <span>
                  J'accepte les spécifications et les hypothèses du plan
                </span>
              ) : (
          ...
          <div className="form-checkbox-group">
            <input
              id="pad-details-checkbox"
              type="checkbox"
              value={padCheck}
              onChange={() => setPadCheck(!padCheck)}
            />
